...
EXPECTED_OBJECTS = {
    "kernel": {
        "tables": {
            ...
            "artifact_payload_metadata",
            "artifact_lifecycle_task_packets",
            "artifact_lifecycle_replay_projection_comparisons",
            "encrypted_storage_descriptors",
            "encrypted_storage_key_rotations",
            "payload_access_receipts",
            "encrypted_storage_access_verification_states",
            "encrypted_storage_replay_projection_comparisons",
            "backup_cadence_records",
            "restore_drill_packets",
            "recovery_checklist_receipts",
            "recovery_verification_states",
            "recovery_replay_projection_comparisons",
        ...
        "indexes": {
            ...
            "idx_artifact_governance_records_artifact",
            "idx_artifact_governance_records_action",
            "idx_artifact_payload_metadata_due",
            "idx_artifact_payload_metadata_artifact",
            "idx_artifact_lifecycle_task_packets_due",
            "idx_artifact_lifecycle_task_packets_artifact",
            "idx_artifact_lifecycle_replay_projection_artifact",
            "idx_encrypted_storage_descriptors_owner",
            "idx_encrypted_storage_key_rotations_descriptor",
            "idx_payload_access_receipts_descriptor",
            "idx_encrypted_storage_access_verification_descriptor",
            "idx_encrypted_storage_replay_projection_descriptor",
            "idx_backup_cadence_records_status_due",
            "idx_restore_drill_packets_cadence",
            "idx_recovery_checklist_receipts_drill",
            "idx_recovery_verification_states_status",
            "idx_recovery_replay_projection_drill",
            "idx_recovery_readiness_packets_scope_status",
            "idx_recovery_readiness_replay_projection_packet",
            "idx_hermes_adapter_readiness_packets_adapter_status",
            "idx_hermes_adapter_readiness_replay_projection_packet",
            "idx_migration_readiness_records_action_status",
            "idx_migration_readiness_replay_projection_scope",
    ...
    "operator_digest": {
        "tables": {
            ...
            "kernel_migration_readiness_projection",
        ...
        "indexes": {
            ...
            "idx_kernel_migration_projection_action_status",
